...
return [
    ...
    'edit.item.title_add' => 'Add Menu Item',
    'edit.item.title_edit' => 'Edit Menu Item',
    'edit.item.label' => 'Label',
    'edit.item.url' => 'URL',
    'edit.item.target' => 'Target',
    ...
    'edit.structure.empty' => 'No menu items yet. Use the form on the left to add items.',
];
